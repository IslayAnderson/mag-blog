...
function gdstheme_comments($comment)
{
    ...
    <div id="comment-<?php comment_ID(); ?>" <?php comment_class('cf'); ?>>
        <div class="govuk-inset-text">
            ...
            ?>
            <img src="http://www.gravatar.com/avatar/<?php echo md5($bgauthemail); ?>"
            ...
            <time datetime="<?php echo comment_time('Y-m-j'); ?>"><a
                        href="<?php echo htmlspecialchars(get_comment_link($comment->comment_ID)) ?>"><?php comment_time(__('F jS, Y', 'gdstheme')); ?> </a>
            </time>
            <?php comment_text() ?>
        </div>
